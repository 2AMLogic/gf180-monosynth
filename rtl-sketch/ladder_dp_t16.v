...
module ladder_dp #(
    ...
    reg signed [TW-1:0] tanh_rom [0:16];
    initial $readmemh("tanh16.hex", tanh_rom);
    ...
    function [4:0] taddr(input signed [SW-1:0] v);
        taddr = {1'b0, v[SW-2 -: 4]} ^ 5'h10;   // signed -> unsigned index
    endfunction
