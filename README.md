...
<!-- HISTORY:BEGIN -->
Measured from git, not remembered. **101 commits over 26 hours.**
...
| `F3` | Measurement ground truth | **GREEN** | 111 passed in 2.74s |
...
| `D2` | Is an 808, per the reference **fidelity** | **RED** | 1 failed, 32 passed in 24.94s |
