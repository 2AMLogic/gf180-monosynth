...
<!-- HISTORY:BEGIN -->
Measured from git, not remembered. **58 commits over 21 hours.**

| | now | per hour |
|---|---:|---:|
| tests | 364 | 17.3 |
| injected controls | 74 | 3.5 |
| bit-exact verifiers | 7 | — |
| lines of RTL | 4,919 | 234 |
...
| `F3` | Measurement ground truth | **GREEN** | 99 passed in 2.46s |
...
| `D2` | Is an 808, per the reference **fidelity** | **GREEN** | 102 passed in 380.28s (0:06:20) |
