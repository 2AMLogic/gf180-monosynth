...
<!-- HISTORY:BEGIN -->
Measured from git, not remembered. **84 commits over 23 hours.**

| | now | per hour |
|---|---:|---:|
| tests | 496 | 21.2 |
| injected controls | 82 | 3.5 |
| bit-exact verifiers | 7 | — |
| lines of RTL | 4,960 | 212 |
...
| `F3` | Measurement ground truth | **GREEN** | 99 passed in 2.42s |
...
| `D2` | Is an 808, per the reference **fidelity** | **GREEN** | 102 passed in 347.17s (0:05:47) |
