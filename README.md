...
<!-- HISTORY:BEGIN -->
Measured from git, not remembered. **103 commits over 26 hours.**

| | now | per hour |
|---|---:|---:|
| tests | 569 | 22.1 |
| injected controls | 82 | 3.2 |
| bit-exact verifiers | 7 | — |
| lines of RTL | 4,960 | 192 |
...
| `F3` | Measurement ground truth | **GREEN** | 111 passed in 2.27s |
...
| `D2` | Is an 808, per the reference **fidelity** | **RED** | 1 failed, 32 passed in 27.88s |
