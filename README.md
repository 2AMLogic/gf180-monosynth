...
<!-- HISTORY:BEGIN -->
Measured from git, not remembered. **63 commits over 22 hours.**

| | now | per hour |
|---|---:|---:|
| tests | 395 | 18.2 |
| injected controls | 74 | 3.4 |
| bit-exact verifiers | 7 | — |
| lines of RTL | 4,919 | 227 |
...
| `F3` | Measurement ground truth | **GREEN** | 99 passed in 1.81s |
...
| `D2` | Is an 808, per the reference **fidelity** | **GREEN** | 102 passed in 189.96s (0:03:09) |
