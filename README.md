...
<!-- HISTORY:BEGIN -->
Measured from git, not remembered. **65 commits over 22 hours.**

| | now | per hour |
|---|---:|---:|
| tests | 395 | 18.0 |
| injected controls | 76 | 3.5 |
| bit-exact verifiers | 7 | — |
| lines of RTL | 4,960 | 226 |
...
| `F3` | Measurement ground truth | **GREEN** | 99 passed in 2.50s |
...
| `D2` | Is an 808, per the reference **fidelity** | **GREEN** | 102 passed in 384.67s (0:06:24) |
